"""
test_extraction_invalidation_review.py — Step 2 §11 review lockstep + §12.2/§12.3
...
Run: python -m pytest tests/calibration/test_extraction_invalidation_review.py -q
"""
