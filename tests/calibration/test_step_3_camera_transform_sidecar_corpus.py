"""
test_step_3_camera_transform_sidecar_corpus.py — Step 3 Phase 4: stored builder.
...
Run: python -m pytest tests/calibration/test_step_3_camera_transform_sidecar_corpus.py -q
"""
