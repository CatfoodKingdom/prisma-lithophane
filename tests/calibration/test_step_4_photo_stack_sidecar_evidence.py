"""
test_step_4_photo_stack_sidecar_evidence.py — Step 4 Stage 4.5: Photo-Stack
...
Run: python -m pytest tests/calibration/test_step_4_photo_stack_sidecar_evidence.py -q
"""
