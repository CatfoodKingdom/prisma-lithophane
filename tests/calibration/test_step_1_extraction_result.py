"""
test_step_1_extraction_result.py — Step 1: the unified extraction_result sidecar.
...
calibration sys.path). Run from repo root:
    python -m pytest tests/calibration/test_step_1_extraction_result.py -q
"""
...
class TestSchema:
    ...
    def test_nonpositional_unique_indices_accepted(self):
        ...
        # rejection is covered in test_step_4_extraction_result_validator.py.
        r = ExtractionResult(
