"""
test_step_4_spline_sidecar_adapter.py — Step 4 Stage 4.1: the spline sidecar
...
Run: python -m pytest tests/calibration/test_step_4_spline_sidecar_adapter.py -q
"""
