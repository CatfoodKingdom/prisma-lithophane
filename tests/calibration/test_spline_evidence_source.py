"""
test_spline_evidence_source.py — Step 4 Stage 4.3: production spline reads measured
...
Run: python -m pytest tests/calibration/test_spline_evidence_source.py -q
"""
