...
const steps = Object.freeze([
  ...
  make("modify-basic-profile", "Modify Basic", "The Settings Profile bar currently shows **Basic** with no modified badge. **Basic** uses **Max Thickness: 3.0 mm**.\n\nChange **Max Thickness** to **2.6 mm**. The **modified** badge shows that the current Settings now differ from the saved Basic Settings Profile.", { target: "saving.settings-thickness", group: "settings", completion: event("config.synced", "saving.settings-2.6-modified") }),
  ...
  make("modify-named-settings-profile", "Change the new Settings Profile without saving", "`{{savedProfileName}}` is now saved with **Max Thickness: 2.6 mm**.\n\nChange **Max Thickness** back to **3.0 mm**, but do not save. The **modified** badge shows that the current Settings differ from the saved Settings Profile.", { target: "saving.settings-thickness", group: "settings", completion: event("config.synced", "saving.settings-3.0-modified") }),
  make("open-settings-profiles-with-modified-draft", "See what Reload Saved Version will restore", "The Profiles window lists Saved Settings Profiles. When the loaded Settings Profile has unsaved changes, selecting that same Settings Profile offers **Reload Saved Version**. Reloading would discard the current **3.0 mm** value and restore the **2.6 mm** value you saved earlier.\n\nWhen you load a different Settings Profile, Prisma first asks whether to save or discard the unsaved changes, or cancel the load.\n\nSelect **Load** to view `{{savedProfileName}}` and its saved version.", { target: "saving.settings-profiles", group: "settings", surfaces: ["#settingsProfileModal"], completion: event("settings.profile-browser.opened", "saving.settings-browser-open", false) }),
...
export const SAVING_AND_LOADING_GUIDE = freezeGuide({
  ...
  preflight_actions: Object.freeze([
    Object.freeze({ action: "settings.require_basic", input: Object.freeze({ values: Object.freeze({ t_max: 3, layer_height: 0.08, d_wb: 0.2, min_cap_layers: 2, base_filament: "bambu-tough-white", cap_filament: "__same__", luminance_mode: "standard" }) }), result_key: "basicProfile" }),
