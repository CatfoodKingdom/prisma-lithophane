...
const STEPS = Object.freeze([
  ...
  step({
    id: "active-nozzle",
    title: "Changing the Nozzle Size",
    body: "Prisma uses the selected nozzle size to evaluate whether features in a lithophane can be printed reliably. You may change the active nozzle at any time.",
