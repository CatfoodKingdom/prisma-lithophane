import { chapter, freezeGuide } from "../../core/schema.js?v=2026-08-12-guide-companion-v4";
import {
  BASICS_DETOURS,
  BASICS_EXPORT_SPINE,
  BASICS_IMAGE_SPINE,
  ...
  SOLVE_A_PREPARATION,
} from "./content.js?v=2026-08-12-guide-companion-v4";
...
const ROUTES = Object.freeze({
  ...
  settings: Object.freeze({
    ...
    summary: "Review essential solve controls, Settings Profiles, the Color Solver, and White Cap.",
