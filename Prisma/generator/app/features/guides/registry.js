import { validateGuideDefinitions } from "./core/schema.js?v=2026-08-04-saving-loading-fixes-v1";
import { GUIDED_SETUP_GUIDE } from "./definitions/guided-setup/guide.js";
import {
  BASICS_GUIDE,
  BASICS_LAUNCH_ALIASES,
  BASICS_ROUTE_VIEWS,
} from "./definitions/prisma-generator-basics/guide.js";
import {
  GUIDED_SETUP_HELP_POINTER,
  INTERFACE_PREVIEW_GUIDE,
} from "./definitions/interface-preview/guide.js";
import { SAVING_AND_LOADING_GUIDE } from "./definitions/saving-and-loading/guide.js?v=2026-08-04-saving-loading-fixes-v1";
