...
function settingsDrawerTarget(id, spotlightSelector, frameSelectors) {
  return layeredTarget({
    spotlightRegions: [{
      selector: spotlightSelector,
      all: spotlightSelector.includes("data-guide-target-part"),
    }],
    frameRegions: frameSelectors.map(selector => ({ selector, all: false })),
    placementRegions: [{ selector: spotlightSelector, all: false }],
  }, id);
}

const SETTINGS_DRAWER_TARGETS = Object.freeze(Object.fromEntries([
  ["settings-drawer.essentials.solve-mode", '[data-settings-group="geometry"]', ['[data-setting-key="luminance_mode"]']],
  ["settings-drawer.essentials.solve-pitch", '[data-settings-group="geometry"]', ['[data-setting-key="solve_pitch_extrusion_width_multiplier"]']],
  ["settings-drawer.essentials.max-total-thickness", '[data-settings-group="geometry"]', ['[data-setting-key="t_max"]']],
  ["settings-drawer.essentials.layer-height", '[data-settings-group="geometry"]', ['[data-setting-key="layer_height"]']],
  ["settings-drawer.essentials.white-filament", '[data-settings-group="geometry"]', ['[data-setting-key="base_filament"]']],
  ["settings-drawer.essentials.base-thickness", '[data-settings-group="geometry"]', ['[data-setting-key="d_wb"]']],
  ["settings-drawer.essentials.min-cap-layers", '[data-settings-group="geometry"]', ['[data-setting-key="min_cap_layers"]']],
  ["settings-drawer.preprocessing.resample-kernel", '[data-settings-group="preprocessing"]', ['[data-setting-key="source_resample_kernel"]']],
  ["settings-drawer.preprocessing.order", "#moduleToggles", ["#moduleToggles"]],
  ["settings-drawer.preprocessing.noise-reduction", '[data-settings-group="preprocessing"]', ['[data-setting-key="module:a1_bilateral_denoise"]']],
  ["settings-drawer.preprocessing.print-scale-smoothing", '[data-settings-group="preprocessing"]', ['[data-setting-key="module:b1_printscale_bilateral"]']],
  ["settings-drawer.preprocessing.flat-area-smoothing", '[data-settings-group="preprocessing"]', ['[data-setting-key="module:b3_tv_flatten"]']],
  ["settings-drawer.preprocessing.palette-tone-fit", '[data-settings-group="preprocessing"]', ['[data-setting-key="module:c1_achievable_tonemap"]']],
  ["settings-drawer.preprocessing.palette-saturation-fit", '[data-settings-group="preprocessing"]', ['[data-setting-key="module:c2_soft_gamut_compress"]']],
  ["settings-drawer.solver.appearance-model", '[data-settings-group="solver"]', ['[data-setting-key="appearance_model_provider"]']],
  ["settings-drawer.solver.white-point-rescale", '[data-settings-group="solver"]', ['[data-setting-key="gamut_white_rescale"]']],
  ["settings-drawer.solver.max-colors", '[data-settings-group="solver"]', ['[data-setting-key="k_max"]']],
  ["settings-drawer.solver.mismatch-tolerance", '[data-guide-target-part="settings.solver.color-matching"]', ['[data-setting-key="de_threshold"]']],
  ["settings-drawer.solver.out-of-gamut", '[data-guide-target-part="settings.solver.color-matching"]', ['[data-setting-key="gamut_mode"]']],
  ["settings-drawer.solver.chroma-weight", '[data-guide-target-part="settings.solver.color-matching"]', ['[data-setting-key="chroma_weight"]']],
  ["settings-drawer.solver.region-method", '[data-guide-target-part="settings.solver.region-planning"]', ['[data-setting-key="cell_mode"]']],
  ["settings-drawer.solver.region-target", '[data-guide-target-part="settings.solver.region-planning"]', ['[data-setting-key="color_region_target_mm"]']],
  ["settings-drawer.solver.planning-scale", '[data-guide-target-part="settings.solver.region-planning"]', ['[data-setting-key="stage1_coarsening_factor"]']],
  ["settings-drawer.solver.neutral-field", '[data-guide-target-part="settings.solver.region-refinement"]', ['[data-setting-key="neutral_field_protection_enabled"]', '.neutral-field-preset-row', '[data-setting-key="neutral_field_protection_cutoff"]']],
  ["settings-drawer.solver.local-corrections", '[data-guide-target-part="settings.solver.region-refinement"]', ['[data-setting-key="stage2_fine_override_enabled"]']],
  ["settings-drawer.solver.boundary-mutation", '[data-guide-target-part="settings.solver.region-refinement"]', ['[data-setting-key="stage2_boundary_mutation_enabled"]']],
  ["settings-drawer.solver.mutation-controls", '[data-guide-target-part="settings.solver.region-refinement"]', ['[data-setting-key="stage2_boundary_mutation_max_passes"]', '[data-setting-key="stage2_boundary_mutation_min_gain"]']],
  ["settings-drawer.white-cap.cap-style", '[data-guide-target-part="settings.white-cap.boundary"]', ['[data-setting-key="cap_mode"]']],
  ["settings-drawer.white-cap.appearance-budget", '[data-guide-target-part="settings.white-cap.boundary"]', ['[data-setting-key="boundary_cap_de_budget"]']],
  ["settings-drawer.white-cap.smoothing-radius", '[data-guide-target-part="settings.white-cap.boundary"]', ['[data-setting-key="boundary_cap_smoothing_radius_mm"]']],
  ["settings-drawer.white-cap.detail-depth", '[data-guide-target-part="settings.white-cap.detail"]', ['[data-setting-key="detail_cap_max_layers"]']],
  ["settings-drawer.luminance.drawer-changes", '[data-guide-target-part="settings.white-cap.boundary"]', ['[data-setting-key="luminance_base_shading_limit_fraction"]']],
  ["settings-drawer.luminance.preprocessing", "#moduleToggles", ['[data-guide-module-toggle="a1_bilateral_denoise"]', '[data-guide-module-toggle="b1_printscale_bilateral"]', '[data-guide-module-toggle="b3_tv_flatten"]', '[data-guide-module-toggle="c1_achievable_tonemap"]']],
  ["settings-drawer.luminance.region-controls", '[data-guide-target-part="settings.solver.region-planning"]', ['[data-setting-key="cell_mode"]', '[data-setting-key="stage1_coarsening_factor"]', '[data-setting-key="color_region_target_mm"]']],
  ["settings-drawer.luminance.shading-balance", '[data-guide-target-part="settings.white-cap.boundary"]', ['[data-setting-key="luminance_base_shading_limit_fraction"]']],
  ["settings-drawer.luminance.shading-balance-suggest", '[data-guide-target-part="settings.white-cap.boundary"]', ["#cfgBaseShadingLimitSuggest"]],
].map(([id, spotlightSelector, frameSelectors]) => [
  id,
  settingsDrawerTarget(id, spotlightSelector, frameSelectors),
])));
...
const TARGETS = Object.freeze({
  ...SETTINGS_DRAWER_TARGETS,
  "settings-drawer.essentials.thickness-budget": layeredTarget({
    spotlightRegions: [
      { selector: '[data-settings-group="geometry"]', all: false },
    ],
    frameRegions: [
      { selector: '[data-setting-key="t_max"]', all: false },
      { selector: '[data-setting-key="layer_height"]', all: false },
      { selector: '[data-setting-key="d_wb"]', all: false },
      { selector: '[data-setting-key="min_cap_layers"]', all: false },
    ],
    placementRegions: [
      { selector: '[data-settings-group="geometry"]', all: false },
    ],
  }, "settings-drawer.essentials.thickness-budget"),
  "settings-drawer.open-and-advanced": dynamicTarget(
    app => app.state.settings.settingsDrawerOpen
      ? app.state.ui.$("#settingsAdvancedToggle")
      : app.state.ui.$('[data-guide-target="topbar.settings"]'),
    "settings-drawer.topbar-settings",
  ),
  "settings-drawer.luminance.region-controls": layeredTarget({
    spotlightRegions: [
      { selector: '[data-guide-target-part="settings.solver.region-planning"]', all: true },
      { selector: '[data-guide-target-part="settings.solver.region-refinement"]', all: true },
    ],
    frameRegions: [
      { selector: '[data-setting-key="cell_mode"]', all: false },
      { selector: '[data-setting-key="stage1_coarsening_factor"]', all: false },
      { selector: '[data-setting-key="color_region_target_mm"]', all: false },
    ],
    placementRegions: [
      { selector: '[data-guide-target-part="settings.solver.region-refinement"]', all: true },
    ],
  ...
  "sidebar.active-extrusion-width": staticTarget('[data-guide-target="sidebar.active-extrusion-width"]', "sidebar.active-extrusion-width"),
  ...
  "settings-drawer.topbar-settings": staticTarget(
    '[data-guide-target="topbar.settings"]',
    "settings-drawer.topbar-settings",
  ),
  ...
  "settings.preprocessing-solver": groupedTarget([
    {
      selector: '[data-settings-group="preprocessing"], [data-settings-flow-group="preprocessing"]',
      all: true,
    },
    {
      selector: '[data-settings-group="solver"], [data-settings-flow-group="solver"]',
      all: true,
    },
...
const KNOWN_GUIDE_PREDICATES = new Set([
  ...
  "settings.drawer-open-and-advanced",
...
export function installFeaturesGuidesTargets(app) {
  ...
  function revealGuideTarget(revealId, { reviewOnly = false } = {}) {
    ...
    if (revealId === "settings-drawer.topbar-settings") return;
    if (revealId.startsWith("settings-drawer.")) {
  ...
  function tutorialPrinterReady({ requireWidth = false } = {}) {
    const runtime = context(app);
    ...
    const setup = printersData?.printer_setup_state?.["tutorial-printer"];
    return printersData?.active_printer_id === "tutorial-printer"
      && structurallyEqual(profile, runtime.tutorialPrinterProfile)
      && (!requireWidth || (
        setup?.active_nozzle_id === "nozzle-400"
        && setup?.nozzle_width_state?.["nozzle-400"]?.current_width_um === 400
      ));
  }
  ...
  function guidePredicateSatisfied(predicateId) {
    ...
    if (predicateId === "basics.tutorial-extrusion-width-active") {
      return tutorialPrinterReady({ requireWidth: true });
    }
    ...
    if (predicateId === "basics.canvas-ready") {
      ...
      return app.state.image.selectedImage?.filename === runtime.tutorialImageFilename
        && app.state.image.selectedImage?.source_ref === runtime.tutorialImageSourceRef
        && tutorialPrinterReady({ requireWidth: true })
    ...
    if (predicateId === "settings.drawer-open-and-advanced") {
      return guidePredicateSatisfied("settings.drawer-open")
        && guidePredicateSatisfied("settings.advanced-on");
    }
    if (predicateId === "settings.advanced-on") {
      return !!app.state.settings.settingsAdvancedVisible;
    }
    ...
    if (predicateId === "saving.prepared") {
      ...
      return app.state.settings.loadedProfileRef?.id === basicId
        ...
        && app.state.session.printersData?.printer_setup_state?.["tutorial-printer"]?.nozzle_width_state?.["nozzle-200"]?.current_width_um === 200
  ...
  function guideAuthorizesPrintSetupIntent(intent = {}) {
    const predicateId = app.state.guides.currentStep?.completion?.predicate_id;
    if (predicateId === "basics.tutorial-printer-active") {
      return intent.intent_kind === "select_printer"
        && intent.active_printer_id === "tutorial-printer";
    }
    if (predicateId === "basics.tutorial-extrusion-width-active") {
      if (app.state.session.printersData?.active_printer_id !== "tutorial-printer") return false;
      if (intent.intent_kind === "select_nozzle") {
        return intent.active_nozzle_id === "nozzle-400";
      }
      return intent.intent_kind === "select_extrusion_width"
        && intent.active_nozzle_id === "nozzle-400"
        && Number(intent.current_width_um) === 400;
    }
    return false;
  }
  ...
  Object.assign(app.commands, {
    ...
    cleanupGuideRuntime,
    formatGuideText,
    guideAuthorizesPrintSetupIntent,
